...
"""
STREAM CLASSIFICATION LIVE INFERENCE CLIENT FOR RTSP
====================================================

The following program is used to perform live data inference on the subject data & display results through RTSP
"""
